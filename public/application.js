...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jobsEvents = __webpack_require__(13);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://burger-joint-p2.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetJob = function onGetJob(event) {
	  event.preventDefault();
	  var job = getFormFields(event.target).job;
	  api.getJob(job.id).then(ui.onGetJobSuccess).catch(ui.onGetJobFailure);
	};

	var getJobs = function getJobs() {
	  $('.content').empty();
	  api.getJobs().then(ui.onGetJobsSuccess).catch(ui.onGetJobsFailure);
	};
	...
	var onUpdateJob = function onUpdateJob(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateJob(data).then(ui.onUpdateSuccess).catch(ui.onUpdateJobFailure);
	};
	...
	var onDeleteJob = function onDeleteJob(event) {
	  ...
	  api.deleteJob(id).then(ui.onDeleteJobSuccess).catch(ui.onDeleteJobFailure);
	};

	var onMarkComplete = function onMarkComplete(event) {
	  event.preventDefault();
	  var id = event.target.getAttribute('data-id');
	  api.markComplete(id).then(ui.onMarkCompleteSuccess).catch(ui.onMarkCompleteFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var displayJobsTemplate = __webpack_require__(16);
	// const displaySingleJobTemplate = require('../templates/single-job.handlebars')
	var api = __webpack_require__(14);

	var refreshHandlebar = function refreshHandlebar() {
	  $('.content').empty();
	  api.getJobs().then(onGetJobsSuccess).catch(onGetJobsFailure);
	};

	var onCreateJobSuccess = function onCreateJobSuccess(data) {
	  $('#job-create-modal-form').trigger('reset');
	  $('#job-create-modal').modal('hide');
	  refreshHandlebar();
	};

	var onCreateJobFailure = function onCreateJobFailure(data) {
	  $('#job-create-modal-form').trigger('reset');
	...
	var onGetJobsSuccess = function onGetJobsSuccess(data) {
	  ...
	  var displayJobsHtml = displayJobsTemplate({ jobs: data.jobs });
	  $('.content').append(displayJobsHtml);
	};

	var onGetJobsFailure = function onGetJobsFailure(error) {
	  console.error('onGetJobsFailure: ', error);
	  refreshHandlebar();
	};

	var onGetJobSuccess = function onGetJobSuccess() {
	  // console.log('onGetJobSuccess')
	  refreshHandlebar();
	};

	var onGetJobFailure = function onGetJobFailure(error) {
	  console.error('onGetJobFailure: ', error);
	  refreshHandlebar();
	};

	var onMarkCompleteSuccess = function onMarkCompleteSuccess() {
	  refreshHandlebar();
	};
	var onMarkCompleteFailure = function onMarkCompleteFailure(error) {
	...
	var onDeleteJobFailure = function onDeleteJobFailure(error) {
	  console.error('onDeleteJobFailure: ', error);
	  refreshHandlebar();
	};
	...
	module.exports = {
	  ...
	  onGetJobsFailure: onGetJobsFailure,
	  onGetJobSuccess: onGetJobSuccess,
	  onGetJobFailure: onGetJobFailure,
	  onMarkCompleteSuccess: onMarkCompleteSuccess,
	  onMarkCompleteFailure: onMarkCompleteFailure,
	  onDeleteJobSuccess: onDeleteJobSuccess,
	  onDeleteJobFailure: onDeleteJobFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n        <div id=\"task-handbar\" class=\"task center-block\" data-value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n\n          <label data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n"
	    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.completed : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "          </label>\n\n          <button type=\"submit\" class=\"close delete-job-button\" aria-label=\"Delete\">\n          <span aria-hidden=\"true\" data-id="
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias3,{"name":"id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + ">\n            &times; </span>\n          </button>\n\n        </div>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, helper, alias1=container.escapeExpression;

	  return "              <input class=\"edit btn\" type=\"checkbox\" autocomplete=\"off\" checked data-id="
	    + alias1(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "> <span style='color:red;text-decoration:line-through' class=\"task-name\"> "
	    + alias1(((helper = (helper = helpers.task || (depth0 != null ? depth0.task : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"task","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + " <span>\n";
	},"4":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, helper, alias1=container.escapeExpression;

	  return "              <input class=\"edit btn\" type=\"checkbox\" autocomplete=\"off\" data-id="
	    + alias1(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.jobs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
